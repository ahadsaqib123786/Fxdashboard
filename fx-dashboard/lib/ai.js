...
export function riskClassification(confluence) {
  if (confluence.qualifies) return "Display"; // today's single best opportunity
  if (confluence.grade === "Monitor") return "Monitor";
  return "Ignore";
}
...
## Risk Assessment
State the classification given to you exactly as given (Display, Monitor, or Ignore) and explain briefly why, in balanced terms. Never say the trade is guaranteed.
