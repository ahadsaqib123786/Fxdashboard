...
// `opportunities` (every other scanned pair) is included for future
// Premium surfaces (e.g. a watchlist page) but intentionally unused by the
// Market Pulse page itself, which only ever shows the single best setup.
