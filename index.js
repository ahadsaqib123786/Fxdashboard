...
import ClosestPairCard from "../components/ClosestPairCard";
...
export default function MarketPulse() {
  ...
  const { marketStatus, bestTrade, closestPair, aiSummary, aiSource, scannedAt } = data;
  ...
  return (
    <div>
      ...
      {bestTrade ? (
        ...
        <>
          <MarketStatusBanner status={marketStatus.status} headline={marketStatus.headline} />
          {closestPair && <ClosestPairCard pair={closestPair} />}
        </>
      )}

      {(bestTrade || closestPair) && (
